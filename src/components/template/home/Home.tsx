        ...
        <div className="flex justify-center relative">
            <div className="mb-10 mt-[100px]">
                ...
                <div className="flex justify-center">
                    <PresentContactSocial title="https://github.com/Bang222" color="bg-sky-300 observe-right" icon={<FaGithub color="black" />} />
                    <PresentContactSocial title="https://www.linkedin.com/in/bang-danh-pham-cong-919475250/" color="bg-sky-300 observe-home-middle" icon={<FaLinkedin color="blue" />} />
                    <PresentContactSocial title="https://www.facebook.com/zeusoc/" color="bg-sky-300 observe-home-left" icon={<FaFacebookSquare color="blue" />} />
                </div>
